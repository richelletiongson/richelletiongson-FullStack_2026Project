    ...
    <section className="cookie-forecast-wrapper">
      ...
      <div className="cookie-viewport">
        <div className="cookie-scene">
          ...
          <img
            src="/images/cookie/asset-2.png"
            alt="Fortune cookie"
            className={`cookie-asset cookie-asset-2 ${shake ? 'cookie-shake' : ''} ${
              hasPlayed ? 'cookie-asset-2-hidden' : ''
            }`}
            onClick={handleClick}
          />
      ...
      <style jsx>{`
        ...
        .cookie-viewport {
          ...
          background: radial-gradient(circle at top, #ffe9c7 0, #f6b88b 40%, #d97b5a 100%);
          overflow: hidden;
        }
